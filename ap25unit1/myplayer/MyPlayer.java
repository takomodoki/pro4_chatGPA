...
public class MyPlayer extends ap25.Player {
  ...
  public MyPlayer(String name, Color color, MyEval eval, int depthLimit) {// Myplayerコンストラクタの多重定義
    super(name, color);
    this.eval = eval;
  ...
  public MyPlayer(String name, Color color, int depthLimit) {// Myplayerコンストラクタの多重定義
